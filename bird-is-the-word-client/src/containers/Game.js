      ...
      return (
        <div>
          ...
          <button onClick={() => {
            ...
            else if (this.props.game.player_1 && this.props.game.player_2 && this.props.game.turn % 2 !== 0 && this.props.current_player_number === 2){
                alert("Please wait for player 1 to take their turn!")
                this.props.getGame(this.props.game.id)   
              }
            else if (this.props.game.player_1 && this.props.game.player_2 && this.props.game.turn % 2 === 0 && this.props.current_player_number === 1){
